...
public interface Ac {
    ...
    //Interface lerin icine "concrete method" konulamaz, cunku "concrete methodlarda" body vardir ve body o method'un isi nasil yapacagi
    ...
    //Interface lerde tum methodlar publictir, unstatictir,abstractir
    //Interface'ler "concrete" method icermezler, dolayisiyla interface'in icindeki hicbir method istege bagli degildir
